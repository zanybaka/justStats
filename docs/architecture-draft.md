...
**Approvals required:** the author (sole author/decision-maker — no formal committee for this project; this document substitutes for one, per the repo's solo-maintainer context).
